namespace StudyfiedBackend.Controllers.Gemini
{
    public static class PromptHelper
    {
        ...
        private static string[] helpers =
        {
            ...
            "You are a chatbot, the next prompt will containing our previous conversation, reply to my latest message using the context from the following conversation: "
        };
